...
export TENSORBOARD_DIR="${TENSORBOARD_DIR:-/mnt/his_test/kechun.wu/0824/verl-hardware-plugin/scripts/musa/tensorboard_logs}"
...
envsubst '${VERL_PATH} ${VERL_PLUGIN_PATH} ${MEGATRON_PATH} ${MEGATRON_BRIDGE_PATH} ${MUSA_PATCH_PATH} ${VERL_MUSA_ATTENTION_DEBUG} ${VERL_SGLANG_HTTP_TIMEOUT} ${TENSORBOARD_DIR} ${NVTE_FLASH_ATTN} ${NVTE_FUSED_ATTN}' \
