...
def _install_mla_asymmetric_v(debug: bool) -> None:
    ...
    original_prepare_mla_value = mcore_mla._prepare_mla_core_attention_value
...
def install() -> None:
    ...
    debug = os.getenv("VERL_MUSA_ATTENTION_DEBUG", "0").lower() in {"1", "true", "yes", "on"}
    ...
    flash_attn_api._flash_attn_varlen_forward = varlen_forward
    flash_attn_api._flash_attn_varlen_backward = varlen_backward
